...
using ECM2;
using Tewi.Game.Interactable.Ladders;
...
namespace Tewi.Game.Player.Abilitys
{
    ...
    public class LadderClimbAbility : MonoBehaviour
    {
        ...
        public void Climb()
        {
            ...
            _ladderTargetPosition = activeLadder.ClosestPointOnPath(_ladderStartPosition, out _ladderPathPosition);
        ...
        public void StopClimbing()
        {
            ...
            _ladderTargetRotation = activeLadder.BottomPoint.rotation;
        }
        ...
        private void ClimbingMovementMode(float deltaTime)
        {
            ...
            switch (_climbingState)
            {
                ...
                case ClimbingState.Releasing:
                {
                    ...
                    {
                        Vector3 interpolatedPosition = Vector3.Lerp(_ladderStartPosition, _ladderTargetPosition, Easing.OutSine(_ladderTime / grabbingTime));
                ...
                case ClimbingState.Grabbed:
                {
                    ...
                    activeLadder.ClosestPointOnPath(_character.GetPosition(), out _ladderPathPosition);
                    ...
                    if (Mathf.Abs(_ladderPathPosition) < 0.05f)
                    {
                        ...
                        velocity = activeLadder.transform.up * (-movementInput.x * climbingSpeed);
                    }
                    else
                    {
                        ...
                        if (_ladderPathPosition > 0.0f)
                        {
                            ...
                            _ladderTargetPosition = activeLadder.TopPoint.position;
                            _ladderTargetRotation = activeLadder.TopPoint.rotation;
                        }
                        else if (_ladderPathPosition < 0.0f)
                        {
                            // Below ladder path bottom point

                            _ladderTargetPosition = activeLadder.BottomPoint.position;
                            _ladderTargetRotation = activeLadder.BottomPoint.rotation;
                        }
                    }
