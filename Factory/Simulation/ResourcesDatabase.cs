...
{
    public class ResourcesDatabase : IDisposable
    {
        ...
        public ResourcesDatabase(int tickRate, ResourceDatabase resourceDatabase, RecipeDatabase recipeDatabase)
        {
        ...
        private void Init(int tickRate)
        {
            InitResource();
            InitRecipe(tickRate);
        }
        ...
        private void InitRecipe(int tickRate)
        {
            recipeDB.Init();
            ...
            foreach (var so in recipeDB.recipes)
            {
                ...
                {
                    id = runtimeRecipeId,
                    durationTicks = (ushort)Mathf.CeilToInt(so.duration * tickRate)
                };
